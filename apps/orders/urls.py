...
from .views import meus_pedidos, detalhe_pedido, customizacao, envio_de_arte, arte_finalizada, detalhe_arte, aprova_arte, envio_prototipo, pegar_card, verifica_prototipo, aprova_prototipo, envio_de_arte_por_quantidade
...
urlpatterns = [
    ...
    path('verifica-prototipo/<int:idOrder>/<int:idProduct>', verifica_prototipo, name='verifica_prototipo'),
